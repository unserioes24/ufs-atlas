...
export const de = {
  ...
  'species.backToList': 'Zurück zur Artenliste',
  'species.fromGuide': 'Aus der Community-Recherche',
  'species.unknown': 'Diese Art gibt es in den Spieldateien nicht.',
  'bait.backToList': 'Zurück zur Köderliste',
  'bait.interestTitle': 'Interesse je Art',
  'bait.openSpecies': 'Art öffnen',
  'bait.noSpecies': 'Für diesen Köder ist keine Art hinterlegt.',
  'bait.unknown': 'Diesen Köder gibt es in den Spieldateien nicht.',
