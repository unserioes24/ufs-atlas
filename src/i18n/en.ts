...
export const en: Partial<Dict> = {
  ...
  'species.backToList': 'Back to the species list',
  'species.fromGuide': 'From community research',
  'species.unknown': 'The game files hold no such species.',
  'bait.backToList': 'Back to the bait list',
  'bait.interestTitle': 'Interest per species',
  'bait.openSpecies': 'Open the species',
  'bait.noSpecies': 'No species is recorded for this bait.',
  'bait.unknown': 'The game files hold no such bait.',
  ...
  // Lure type, in the game's own words
  'baitType.spinner': 'Spinner',
  'baitType.spoon': 'Spoon',
  'baitType.wobbler': 'Hard lure',
  'baitType.softBait': 'Soft lure',
  'baitType.fly': 'Fly',
  'baitType.flyDry': 'Dry fly',
  'baitType.flyWet': 'Wet fly',
  'baitType.flyNymph': 'Nymph',
  'baitType.flyStreamer': 'Streamer',
  'bait.noTableShort': 'no values in the game files',
  'bait.noTableNote':
    'The game files hold no interest values for this bait – all 154 entries are 0. The game evidently works the interest out from the fish the cut came off.',
